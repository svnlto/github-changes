...
module.exports = function (opts, authOptions) {
  ...
  .then(function (data) {
    ...
    data = data.sort(function (a, b) {
      ...
      if (semver.valid(a) && semver.valid(b)) {
        ...
        console.log('', semver.compare(a.tag.name, b.tag.name));
  ...
  .then(function (data) {
    process.stdout.write(formatter.call(this, self, opts, data));
    //fs.writeFileSync(opts.file, formatter.call(this, self, opts, data));
  })
